...
Public Class BehaviourRunner 'StoryRunner
    ...
    Public Sub Run()
        For Each instance As Object In objectsToInspect
            ...
            'Invoke Setup before invoking any ohter methods
            ...
            For Each method As Reflection.MethodInfo In methods
                'At the moment the class must implement IStoryBase, and inherit from Behaviour (and have an attribute <Behaviour>)
